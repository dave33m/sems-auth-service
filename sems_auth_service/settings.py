"""
Django settings for sems_auth_service project.
...
SECRET_KEY = 'django-insecure-#f9n%ydzoelxx_pgr-+p_2g_rt2wek1ri9b#5qfortrz*^%ll6'
...
WSGI_APPLICATION = 'sems_auth_service.wsgi.application'

AUTH_USER_MODEL = "authcore.AuthUser"
